...
for n = 1:3
    %cover image dir
    cover_img_dir = 'D:\test_data\test\cover\';
    cover_img_dir = strcat(cover_img_dir, num2str(n), '\');
    %stego image dir
    stego_img_dir = 'D:\test_data\test\stego\';
    stego_img_dir = strcat(stego_img_dir, num2str(n), '\');
    %recompress cover img dir
    re_cover_img_dir = 'D:\test_data\test\cover_recompress\';
    re_cover_img_dir = strcat(re_cover_img_dir, num2str(n), '\');
    % test for error
for num = 101:600
    ...
    a = payload_(n);
    payload_bits = round(payload_(n)*((nnz(jpeg_coefs) - nnz(jpeg_coefs(1:8:end,1:8:end)))));
