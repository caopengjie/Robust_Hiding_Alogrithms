%% Simulation of embedded to find the robust embedding region
%cover path
jpeg_input = 'test_test.jpg';
%stego path
file_output = 'test_stego.jpg';
%re_compress path
re_compress_file = 're_stego_test.jpg';
...
for i = 1:8
    for j = 1:8
        ...
        file_output = strcat(nums, '_test_stego.jpg');
        re_compress_file = strcat(nums, '_re_stego_test.jpg');
